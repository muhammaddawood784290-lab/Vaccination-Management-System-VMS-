...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            @if($record->notes)<div class="col-span-2"><p class="text-xs text-gray-500">Notes</p><p class="text-sm text-gray-700">{{ $record->notes }}</p></div>@endif
        </div>
    </div>
    <a href="{{ route('hospital.vaccinations.index') }}" class="inline-block px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition">← Back to Records</a>
</div>
@endsection
